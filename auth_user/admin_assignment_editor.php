...
<head>
    ...
    <script type="text/javascript">window.question_bank = <?php include('admin/load_question_bank.php'); ?>;</script>
</head>
<body>
    <?php include('../common/logged_in_bar.php'); ?>
    <h1 id="title" style="margin-bottom:10px;">Assignment Editor</h1>
    ...
    <script type="text/javascript" src="admin/admin_editor_builder.js"></script>
    <script type="text/javascript">
        $(document).ready( function() {
            admin_editor_builder.display_editor();
        });
    </script>
</body>
