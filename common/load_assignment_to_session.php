<?php
    ...
    $get_global_assignment_data = "SELECT name, available, due, graded FROM assignment_manifest WHERE assignmentID = ?";
    ...
    $get_question_data = "SELECT a.question_index,a.question_points,b.questionID,b.question_category,b.question_data FROM assignment_questions a JOIN question_table b ON a.questionID = b.questionID WHERE a.assignmentID = ? ORDER BY a.question_index";
    ...
    if ($user_id != "") {
        $get_response_data = "SELECT question_index,response_data FROM response_table WHERE (assignmentID = ? AND userID = ?) ORDER BY question_index";
        ...
        $stmt->close();
        $get_score_data = "SELECT question_index,score,feedback_data FROM score_table WHERE (assignmentID = ? AND userID = ?) ORDER BY question_index";
        ...
        $get_extension_data = "SELECT extensions FROM assignment_manifest WHERE assignmentID = ?";
